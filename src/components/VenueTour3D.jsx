...
function VenueTour3D({ photos = [] }) {
  ...
  useEffect(() => {
    ...
    const frameMaterial = new THREE.LineBasicMaterial({ color: '#153860', transparent: true, opacity: 0.7 });
    ...
    for (let i = 0; i < count; i++) {
      ...
      if (hasPhotos) {
        ...
        material = new THREE.MeshBasicMaterial({ color: '#90bbd9', transparent: true, opacity: 0.35 });
      }
